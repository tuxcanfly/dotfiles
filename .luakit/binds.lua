...
add_binds("normal", {
    ...
    key({"Control"}, "p", "Toggle Private browsing",
    function (w)
        w.view.enable_private_browsing = not w.view.enable_private_browsing
        domain_props = {
            ["all"] = {
                enable_private_browsing = w.view.enable_private_browsing;
            }
        }
        if(w.view.enable_private_browsing) then
